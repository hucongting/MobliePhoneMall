...
<body>
    ...
    <div class="top">
    	<div class="top-con w1200">
            ...
            <ul class="t-con-r f-r">
            	<li><a href="my_message.jsp">我 (个人中心)</a></li>
            	<li><a href="my_cart.jsp">我的购物车</a></li>
    ...
    <div class="personal w1200">
    	<div class="personal-left f-l">
            ...
            <ul>
            	<li class="current-li per-li1"><a href="my_message.jsp">消息中心<span>></span></a></li>
            	...
            	<li class="per-li5"><a href="my_cart.jsp">购物车<span>></span></a></li>
            	<li class="per-li6"><a href="my_address.jsp">管理收货地址<span>></span></a></li>
            	<li class="per-li7"><a href="my_collection.jsp">店铺收藏<span>></span></a></li>
            	<li class="per-li8"><a href="buyrecord.jsp">购买记录<span>></span></a></li>
            	<li class="per-li9"><a href="lookrecored.jsp">浏览记录<span>></span></a></li>
            	<li class="per-li10"><a href="vip_score.jsp">会员积分<span>></span></a></li>
            </ul>
        </div>
</body>
</html>