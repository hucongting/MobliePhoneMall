 ...
 * @since 2018-09-01
 */
public class Order_detail extends Model<Order_detail> implements Serializable {
	...
	public Order_detail(String detail_id, String order_id, String product_id, String product_name,
			BigDecimal product_price, Integer product_quantity, String product_icon, String created_user,
	...
	public String toString() {
		return "Order_detail [detail_id=" + detail_id + ", order_id=" + order_id + ", product_id=" + product_id
				...
				+ product_quantity + ", product_icon=" + product_icon + ", created_user=" + created_user
