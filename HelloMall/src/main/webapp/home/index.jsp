...
<body>
    ...
    <div class="banner-box">
    	<div class="banner w1200">
        	<ul>
            	<li><a href="product_details.jsp"><img src="http://placehold.it/1200x560/4D99E0/ffffff.png&text=1200x560 1" /></a></li>
                <li><a href="product_details.jsp"><img src="http://placehold.it/1200x560/4D99E0/ffffff.png&text=1200x560 2" /></a></li>
                <li><a href="product_details.jsp"><img src="http://placehold.it/1200x560/4D99E0/ffffff.png&text=1200x560 3" /></a></li>
                <li><a href="product_details.jsp"><img src="http://placehold.it/1200x560/4D99E0/ffffff.png&text=1200x560 4" /></a></li>
                <li><a href="product_details.jsp"><img src="http://placehold.it/1200x560/4D99E0/ffffff.png&text=1200x560 5" /></a></li>
                <li><a href="product_details.jsp"><img src="http://placehold.it/1200x560/4D99E0/ffffff.png&text=1200x560 1" /></a></li>
    ...
    <div class="hot-recommend w1200">
        ...
        <ul class="">
            ...
            <li class="ys2">
            	<p>汽车保养</p>
                <a href="product_details.jsp" class="ys2-a1" style="margin-bottom:25px;">上门汽车保养1一元钱</a>
            	<a href="product_details.jsp"><img src="images/hot-tu2.jpg" /></a>
            </li>
            <li class="ys2">
            	<p>汽车保养</p>
                <a href="product_details.jsp" class="ys2-a1">上门汽车保养1一元钱</a>
                <a href="#"><img src="images/hot-tu3.jpg" /></a>
            </li>
            <li class="ys2" style=" width:298px;">
            	<p>汽车保养</p>
                <a href="product_details.jsp" class="ys2-a1">上门汽车保养1一元钱</a>
            	<a href="product_details.jsp"><img src="images/hot-tu4.jpg" /></a>
            </li>
            <li class="ys1">
            	<a href="product_details.jsp"><img src="images/hot-tu5.jpg" /></a>
                <div class="ys1-opt"></div>
                <div class="ys1-ft">
                	<p>最实惠KTV<br /><span>最佳组合</span></p>
                    <a href="product_details.jsp">点击有实惠</a>
                </div>
            </li>
            <li class="ys1">
            ...
            <li class="ys2">
            	<p>汽车保养</p>
                <a href="product_details.jsp" class="ys2-a1" style="margin-bottom:12px;">上门汽车保养1一元钱</a>
            	<a href="#"><img src="images/hot-tu7.jpg" /></a>
            </li>
            <li class="ys2" style="width:298px;">
            	<p>汽车保养</p>
                <a href="product_details.jsp" class="ys2-a1" style="margin-bottom:15px;">上门汽车保养1一元钱</a>
            	<a href="product_details.jsp"><img src="images/hot-tu8.jpg" /></a>
            </li>
            <div style="clear:both;"></div>
        </ul>
    </div>
        ...
        <div class="ma-con">
            ...
            <ul class="ma-con-r f-l">
            	<li>
                    ...
                    <a href="#"><img src="images/ma-r-tu1.gif" /></a>
                </li>
            	<li>
                	<h3><a href="#">CHBABY多功能环保实木</a></h3>
                    <p><a href="#">婴儿餐椅 CH901</a></p>
    ...
    <ul class="advertisement2">
    	<li><a href="#"><img src="images/lanyuelian.gif" /></a></li>
        <li><a href="#"><img src="images/lanyuelian.gif" /></a></li>
        <li><a href="#"><img src="images/lanyuelian.gif" /></a></li>
        <li><a href="#"><img src="images/lanyuelian.gif" /></a></li>
        <li><a href="#"><img src="images/lanyuelian.gif" /></a></li>
    ...
    <div class="service w1200">
        ...
        <div class="sv-con">
        	...
        	<ul class="sv-con-r f-r">
            	<li>
                	<a href="#"><img src="images/sv-con-r-tu1.gif" /></a>
                    <p>商家：馨诚意家政</p>
    ...
    <div class="salon w1200 mt20">
        ...
        <div class="sa-con">
        	<div class="sa-con-l f-l">
            	<div class="sa-l-t">
                	<a href="#"><img src="images/sa-con-l-t-tu.gif" /></a>
                </div>
            	<div class="sa-l-b">
                	<a href="#">美容</a>
                	<a href="#">美发烫发</a>
        	...
        	<ul class="sa-con-r f-l">
            	<li class="li-ys">
                    ...
                    <a href="#" class="li-tu"><img src="images/sa-con-r-tu1.gif" /></a>
                </li>
                <li>
                	<a href="#"><img src="images/sa-con-r-tu2.gif" /></a>
                    <h3>沙宣应卷修润洗发露 750ml 清仓专区</h3>
                    <a href="#" class="ck">【点击查看】</a>
                    <p>
                        <span class="sp1">¥46.54</span>
                ...
                <li style=" width:304px;height:182px; border-bottom:0;">
                    <a href="#"><img src="images/sa-con-r-tu3.gif" /></a>
                    <h3>沙宣应卷修润洗发露 750ml 清仓专区</h3>
                    <a href="#" class="ck">【点击查看】</a>
                    <p>
                        <span class="sp1">¥46.54</span>
    ...
    <div class="education w1200">
        ...
        <div class="ed-con">
        	<div class="ed-con-l f-l">
            	<div class="ed-l-t">
                	<a href="#"><img src="images/ed-l-tu.gif" /></a>
                </div>
            	<div class="ed-l-b">
            ...
            <ul class="ed-con-r f-l">
            	<li>
                	<a href="#"><img src="images/ed-r-tu1.gif" /></a>
                    <p>商家：宅客微购声乐培训中心</p>
                    <p>类型：高音、中音、低音...服务...</p>
                    <p>好评：<img src="images/sv-con-r-xx.gif" /></p>
                </li>
    ...
    <div class="property w1200 mt20">
        ...
        <div class="prt-con">
        	<div class="prt-con-l f-l">
            	<div class="prt-l-t">
                	<a href="#"><img src="images/prt-l-tu.gif" /></a>
                </div>
            	<div class="prt-l-b">
                	<a href="#">别墅</a>
                	<a href="#">公寓</a>
        	...
        	<ul class="prt-con-r f-l">
            	<li>
                	<a href="#"><img src="images/prt-r-tu1.gif" /></a>
                    <h3>
    ...
    <div class="home w1200">
        ...
        <div class="hm-con">
        	<div class="hm-con-l f-l">
            	<div class="hm-l-t">
                	<a href="#"><img src="images/hm-l-tu.gif" /></a>
                </div>
            	<div class="hm-l-b">
                	<a href="#">厨房卫浴</a>
                	<a href="#">地板瓷砖</a>
        	...
        	<div class="hm-con-m f-l">
            	<ul class="hm-m-t">
                	<li>
                    	<a href="#"><img src="images/hm-m-tu1.gif" /></a>
            	...
            	<div class="hm-m-b">
                	<dl>
                    	<dt><a href="#"><img src="images/hm-m-tu2.gif" /></a></dt>
                        <dd>
        	...
        	<div class="hm-con-r f-l">
            	<dl>
                	<dt>
                    	<a href="#"><img src="images/hm-r-tu.gif" /></a>
                    </dt>
                    <dd>
    ...
    <div class="market w1200 mt20">
        ...
        <div class="mk-con">
        	<div class="mk-con-l f-l">
            	<div class="mk-l-t">
                	<a href="#"><img src="images/mk-l-tu.gif" /></a>
                </div>
            	<div class="mk-l-b">
                	<a href="#">纸品湿巾</a>
                	<a href="#">衣物清洁</a>
        	...
        	<div class="mk-con-m f-l">
            	<dl>
                	<dt><a href="#"><img src="images/mk-m-tu1.gif" /></a></dt>
                    <dd>
                    	<p class="p1">爆款 5折起</p>
                        <a href="#">让洁净立竿见影</a>
                    	<p class="p2"><span>¥46.54</span>  起</p>
        	...
        	<div class="mk-con-r f-l">
            	<dl>
                	<dt><a href="#"><img src="images/mk-r-tu1.gif" /></a></dt>
                    <dd>
                    	<p class="p1">爆款 5折起</p>
                        <a href="#">让洁净立竿见影</a>
                    	<p class="p2"><span>¥46.54</span>  起</p>
